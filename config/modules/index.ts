import type { ViteEnv } from '@pixiu-configs/vite';
...
export function get_modules_config(env: ViteEnv): INuxtConfig {
    const _modules = ['@ant-design-vue/nuxt', '@pinia/nuxt', '@vite-pwa/nuxt', '@pixiu/vue3-pc-ui-nuxt', '@pixiu/vue3-antd-pc-ui-nuxt'];
